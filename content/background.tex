...
For this reason, DDoS-for-Hire providers have built online platforms where DDoS attacks can be ``tested''.
...
In the DDoS-for-Hire community, these testing endpoints are called ``dstats''.
